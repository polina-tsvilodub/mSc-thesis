...
LOG_FILE = '../../data/pretraining_speaker_noEnc_prepend_512dim_4000vocab_teacher_forcing05_desc_pureDecoding_padding_indFixed.txt' # name of file with saved training loss and perplexity
MODE= 'train' # network mode
WEIGHTS_PATH='../../data/final/models/final_pretrained_speaker_coco_4000vocab_tf_desc05_padding_pureDecoding_'
NUM_VAL_IMGS=3700
...
decoder.load_state_dict(torch.load("models/decoder-coco-512dim-teacher_forcing_scheduled_desc_05_byEp_pureDecoding-3.pkl"))
