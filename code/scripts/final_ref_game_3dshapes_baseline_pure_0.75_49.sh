...
do
    ...
    do
        ...
        do
            ...
            -b=64 -l="../../data/final/reference_games/3dshapes/ref_game_3dshapes_pure_decoding_Ls075_49vocab_random.txt" -vf="../../data/vocab3dshapes_fixed.pkl" -tl="../../data/final/reference_games/3dshapes/losses_ref_game_3dshapes_pure_decoding_Ls075_49vocab_random_"\
            -tm="../../data/final/reference_games/3dshapes/metrics_ref_game_3dshapes_pure_decoding_Ls075_49vocab_random_" -vl="" -vm=""\
