...
\begin{table}[]
	\begin{tabularx}{\textwidth}{|X|l|l|l|l|l|l|l|}
		...
		MS Baseline, random, $L_s = 0.25$   &          0.413       &       0.134          &      0.041          &       0.015          &       0.116          &       0.189        &           4.074               \\ \hline
		MS Baseline, random, $L_s = 0.5$   &          0.397       &       0.124          &      0.036          &       0.012          &       0.115          &       0.170         &           4.082               \\ \hline
		MS Baseline, random, $L_s = 0.75$   & 0.407           & 0.133           & 0.037           & 0.010           & 0.116           & 0.178          & 4.056                    \\ \hline
		MS Baseline, random, $L_s = 1$   &                 &                 &                 &                 &                 &                &                          \\ \hline
		...
		3D Baseline, random, $L_s = 0.25$   &                 &                 &                 &                 &                 &                &                          \\ \hline
...
\begin{table}[]
	\begin{tabularx}{\textwidth}{|X|l|l|X|X|X|X|}
		...
		MS Baseline, random, $L_s = 0$      &     -131.890              &         -63.319               &        1.259       &         0.003             &             0.924                             &                                           \\ \hline
		MS Baseline, random, $L_s = 0.25$    &      -133.954             &          -65.533              &          1.173            &       0.004               &           0.935                               &                                           \\ \hline
		MS Baseline, random, $L_s = 0.5$      &         -133.595         &           -67.904             &        1.106              &        0.001              &             0.890                             &                                           \\ \hline
		MS Baseline, random, $L_s = 0.75$   &       -135.910            &             -71.819          &        1.197              &        0.000              & 0.953                                    &                                           \\ \hline
		MS Baseline, random, $L_s =1$  &      -136.762             &          -70.454              &         1.125             &          0.001            &                   0.914                       &                                           \\ \hline
		MS Baseline, similar, $L_s = 0.75$  &                   &                        &                      &                      &                                          &                                           \\ \hline
	\end{tabularx}
...
\begin{figure}
	...
	\caption{Training results of the baseline MS COCO experiment (pure decoding, $L_s = 0.75$). Left: Total speaker train loss. Right: Listener train accuracy.}
...
\end{figure}
\footnotetext{Due to a coding error, semantic drifts were computed on one image-caption pair only and, therefore, the values vary.} 
